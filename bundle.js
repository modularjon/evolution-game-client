...
/***/ function(module, exports, __webpack_require__) {
	...
	var isGameSolved = function isGameSolved(solution, tree) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetUserScore = function onGetUserScore(event) {
	  event.preventDefault();
	  api.indexGames().done(ui.userScoreSuccess).fail(ui.failure);
	};

	var onResetUserScore = function onResetUserScore(event) {
	  event.preventDefault();
	  ...
	  api.resetGame().done(ui.resetUserScoreSuccess).fail(ui.failure);
	};
	...
	var onTraySelect = function onTraySelect(event) {
	  event.preventDefault();
	...
	var onTreeSelect = function onTreeSelect(event) {
	  event.preventDefault();
	...
	var onGameSubmit = function onGameSubmit(event) {
	  event.preventDefault();
	  ...
	  if (!logic.isGameSolved(logic.solution, logic.tree)) {
	    ...
	    api.submitGame().done(ui.submitGameSuccess).fail(ui.failure);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var submitGame = function submitGame() {
	  return $.ajax({
	    url: app.host + '/games/' + app.game.id,
	    method: 'PATCH',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var userScoreSuccess = function userScoreSuccess(data) {
	  ...
	  $('.game-message').text("You\'ve solved " + app.games.filter(function (obj) {
	    return obj.game_solved;
	  }).length + " games.");
	};

	var resetUserScoreSuccess = function resetUserScoreSuccess() {
	  app.game = null;
	...
	var createGameSuccess = function createGameSuccess(data) {
	  ...
	  var solution = app.game.child_taxons;
	  var tray = app.game.child_taxons.shuffled();
	...
	var submitGameSuccess = function submitGameSuccess(data) {
	...
	module.exports = {
	  userScoreSuccess: userScoreSuccess,
	  resetUserScoreSuccess: resetUserScoreSuccess,
	  createGameSuccess: createGameSuccess,
	  submitGameSuccess: submitGameSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
